...
from llm_benchmark.models import BackendConfig, BackendKind, ExperimentSpec, ModelConfig, PlatformConfig
from llm_benchmark.orchestration import BenchmarkPlan, run_benchmark_bundle
...
from llm_benchmark.results_bundle import make_run_id, write_json
from llm_benchmark.runners.registry import build_backend


DEFAULT_EXPERIMENT = "ollama-baseline.yaml"
...
class TUIApp:
    ...
    def do_quick(self, stdscr: Any) -> None:
        ...
        Mirrors ``llm-bench quick "..."`` on the CLI but adds an
        ...
        if wants_save:
            try:
                ...
                print(
                    ...
                    "Re-run save manually with `llm-bench quick ... --save --overwrite`."
                )
            except Exception as exc:  # noqa: BLE001
