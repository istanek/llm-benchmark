...
:class:`llm_benchmark.suites.SuiteDefinition`, which is the canonical
...
def _load_yaml(text: str) -> dict[str, Any]:
    try:
        ...
        raise RuntimeError(
            ...
            "Install llm-benchmark with its full dependency set."
        ) from exc
...
def run_custom_suite_quick(
    *,
    ...
    from llm_benchmark.reporting_html import render_custom_summary_html
