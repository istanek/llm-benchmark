...
class BackendCapabilities(BaseModel):
    ...
    # Can the backend be asked to run the model's reasoning pass? A model
    # config that sets ``reasoning`` on a backend without it is refused rather
    # than quietly measured with reasoning off.
