...
- **Overall score reweighted to 0.70 quality / 0.30 speed**, and the speed
  ...
  tok/s against 74. Most of that move is the data fix rather than the weight —
  with speed in the score at all, gemma-4 falls below nemotron-3 at any speed
  weight above 0.177, including the original 0.20.
